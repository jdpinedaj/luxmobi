...
with TaskGroup(
    ...
    bike_data = PythonOperator(
        task_id="bike_data",
        python_callable=retrieve_bike_data,
        op_kwargs={
            "url": URL_BIKE,
    ...
    charging_station_data = PythonOperator(
        ...
        python_callable=retrieve_charging_station_data,
        op_kwargs={
    ...
    traffic_counter_data_1 = PythonOperator(
        ...
        python_callable=retrieve_traffic_counter_data,
        op_kwargs={
...
with TaskGroup(
    ...
    write_charging_station_data = PythonOperator(
        task_id="write_charging_station_data",
        python_callable=insert_data_to_table,
        op_kwargs={
            "postgres_conn_id": POSTGRESS_CONN_ID,
            "airflow_home": AIRFLOW_HOME,
    ...
    write_traffic_counter_data_1 = PythonOperator(
        task_id="write_traffic_counter_data_1",
        python_callable=insert_data_to_table,
        op_kwargs={
            "postgres_conn_id": POSTGRESS_CONN_ID,
            "airflow_home": AIRFLOW_HOME,
    ...
    write_traffic_counter_data_2 = PythonOperator(
        task_id="write_traffic_counter_data_2",
        python_callable=insert_data_to_table,
        op_kwargs={
            "postgres_conn_id": POSTGRESS_CONN_ID,
            "airflow_home": AIRFLOW_HOME,
    ...
    write_traffic_counter_data_3 = PythonOperator(
        task_id="write_traffic_counter_data_3",
        python_callable=insert_data_to_table,
        op_kwargs={
            "postgres_conn_id": POSTGRESS_CONN_ID,
            "airflow_home": AIRFLOW_HOME,
    ...
    write_traffic_counter_data_4 = PythonOperator(
        task_id="write_traffic_counter_data_4",
        python_callable=insert_data_to_table,
        op_kwargs={
            "postgres_conn_id": POSTGRESS_CONN_ID,
            "airflow_home": AIRFLOW_HOME,
    ...
    write_traffic_counter_data_5 = PythonOperator(
        task_id="write_traffic_counter_data_5",
        python_callable=insert_data_to_table,
        op_kwargs={
            "postgres_conn_id": POSTGRESS_CONN_ID,
            "airflow_home": AIRFLOW_HOME,
    ...
    write_traffic_counter_data_6 = PythonOperator(
        task_id="write_traffic_counter_data_6",
        python_callable=insert_data_to_table,
        op_kwargs={
            "postgres_conn_id": POSTGRESS_CONN_ID,
            "airflow_home": AIRFLOW_HOME,
    ...
    traffic_counter_data_2 >> write_traffic_counter_data_2
    traffic_counter_data_3 >> write_traffic_counter_data_3
